...
from qmt.geometry import build_3d_geometry
from qmt.geometry.part_3d import (ExtrudePart, Geo3DPart, LithographyPart,
                                  SAGPart, WirePart, WireShellPart)
...
block3 = Geo3DPart("Passthrough",
                   "Box",
                   "3d_shape",
                   )

substrate = ExtrudePart("Substrate",
                      "Sketch005",
                      z0=-2,
                      thickness=2)

wrap = LithographyPart(
    "First Layer",
    "Sketch006",
    z0=0,
    layer_num=1,
...
wrap2 = LithographyPart("Second Layer",
                        "Sketch007",
                        layer_num=2,
                        thickness=0.1
)

virt = ExtrudePart("Virtual Domain",
                   "Sketch008",
                    virtual=True,
                    thickness=5.5)
...
input_parts = [block1, block2, sag, virt, wire,
