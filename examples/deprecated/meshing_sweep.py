...
class MeshingTaskExample(Task):
    ...
    def _solve_gathered(self, list_of_input_result_lists, list_of_options):
        ...
        new_delayed_result = \
            qtf.ReducedSweepDelayed.create_from_reduced_sweep_and_manager(
...
class PoissonTaskExample(Task):
    ...
    def _solve_instance(self, input_result_list, current_options):
        ...
        for part in mesh_result_instance.keys():
            output += ' part: ' + part
            output += ', min size: ' + \
                str(mesh_result_instance[part]['min_size'])
...
sweeps = [{tag1: 1., tag2: 10., tag3: 1.}, {tag1: 2., tag2: 10., tag3: 1.}, {
    tag1: 1., tag2: 5., tag3: 1.}, {tag1: 4., tag2: 3., tag3: 2.}]
