...
setup(
    ...
    description=('Qubit Modeling Tools(QMT) for computational modeling of '
                 'quantum devices'),
    url='https://github.com/Microsoft/qmt',
    author=('Andrey Antipov, John Gamble, Jan Gukelberger, Donjan Rodic, '
            'Kevin van Hoogdalem, Georg Winkler'),
