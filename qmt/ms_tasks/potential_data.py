...
class Potential2D(Data):
    def __init__(self, coords, coords_units, data, data_units):
        """
        Constructs Data object stores electrostatic potential information for 2d.

        :param coords: array of shape (n,2) where n is the number of mesh points.
        :param coords_units: units of mesh points
        :param data: array of shape (n,) where n is the number of mesh points
        :param data_units: units of potential data
        """
...
class Potential1D(Data):
    def __init__(self, coords, coords_units, data, data_units):
        """
        Constructs Data object stores electrostatic potential information for 1d.

        :param coords: array of shape (n,1) where n is the number of mesh points.
        :param coords_units: units of mesh points
        :param data: array of shape (n,) where n is the number of mesh points
        :param data_units: units of potential data
        """
