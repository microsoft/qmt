...
class Part3D(object):
    def __init__(
        ...
        :param str directive: The freeCAD directive is used to construct this part. Valid options
        for this are: extrude -- simple extrusion, wire -- hexagonal nanowire about a polyline,
        wire_shell -- shell coating a specified nanowire, sag -- SAG structure, lithography --
        masked layer deposited on top, 3d_shape -- just take the 3D shapre directly.
        ...
        :param float z0: The starting z coordinate. Required for extrude, wire, SAG, and lithography
        directives.
        :param float thickness: The total thickness. Required for all directives. On wireShell,
        this is interpreted as the layer thickness.
        :param str target_wire: Target wire directive for a coating directive.
        :param list shell_verts: Vertices to use when rendering the coating. Required for the
        shell directive.
        :param str depo_zone: FreeCAD sketch defining the (positive) mask for the deposition of a
        ...
        :param list litho_base: The base partNames to use for the lithography directive. For
        multi-step lithography, the bases are just all merged, so there is no need to list this
        more than once.
        :param bool fill_litho: If set to false, will attempt to hollow out lithography steps by
        ...
        z direction.
        :param dict boundary_condition: One or more boundary conditions, if applicable, of the form
        of a type -> value mapping. For example, this could be {'voltage':1.0} or,
        ...
        if subtract_list is None:
            ...
            self.subtract_list = subtract_list
        self.ns = ns
        self.phi_nl = phi_nl
        self.ds = ds
