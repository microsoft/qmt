...
#        :param dict options: Dictionary of the form {"axis":tup,
#            "position":pos,"parts":[part1, part2,...]}, where axis is a
#            3-tuple defining the slice axis, position is the coordinate on the
#            axis to take the cross-section, and parts is an optional list of
#            parts. If it is included, only the part names listed will be
#            included.
...
#        # for spec in options:
#        #     assert (spec == "axis") or (spec == "position") or \
#        #         (spec == "parts")
...
#        """
#        :param list input_result_list: This is a singleton list of a geo_3d
#            object.
#        :param dict current_options: The dictionary specifying parts from
#            above.
...
#        :param dict options: Dictionary of the form {"axis":tup,
#            "position":pos,"parts":[part1,part2,...]}, where axis is a
#            2-tuple defining the slice axis, position is the coordinate on
#            the axis to take the cut, and parts is an optional list of parts.
#            If it is included, only the part names listed will be included.
#        :param str name: The name of this task.
#        """
...
#    def _solve_instance(input_result_list, current_options):
#        """
#        :param list input_result_list: This is a one-element list of a
#            Geometry2D result.
#        :param dict current_options: The dictionary specifying parts from
#            above.
