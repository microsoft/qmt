...
class Geometry_1D(Task):
    def __init__(self,options=None,name='geometry_1d_task'):
        ...
        """
        super(Geometry_1D, self).__init__([], options, name)
...
class Geometry_2D(Task):
    def __init__(self,options=None,name='geometry_2d_task'):
        ...
        :param name: The name of this task.
        """
        super(Geometry_2D, self).__init__([], options, name)
