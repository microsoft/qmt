...
from qmt.basic_tasks import Geometry2D, Geometry3D
...
class ReduceDim3D(Task):
    def __init__(self, geo_3d, options=None, name='reduce_dim_3d_task'):
        ...
        :param geo_3d: The input 3D geometry task
        :param options: Dictionary of the form {"axis":tup,"position":pos,"parts":[part1,part2,...]}, where axis
    ...
    def _solve_instance(self, input_result_list, current_options):
        """
        Reduces a 3D geometry to a 2D geometry for use with 2D solvers.
        :param input_result_list: This is a singleton list of a Geometry3D result.
        :param current_options: The dictionary specifying parts from above.
        :return geo_2d: A geometry2D object
        """
...
class ReduceDim2D(Task):
    def __init__(self, geo_2d, options=None, name='reduce_dim_2d_task'):
        ...
        :param geo_2d: The input 2D geometry task
        :param options: Dictionary of the form {"axis":tup,"position":pos,"parts":[part1,part2,...]}, where axis
    ...
    def _solve_instance(self, input_result_list, current_options):
        """
        Reduces a 2D geometry to a 1D geometry for use with 1D solvers.
        :param input_result_list: This is a singleton list of a Geometry2D result.
        :param current_options: The dictionary specifying parts from above.
        :return geo_1d: A geometry1D object
        """
