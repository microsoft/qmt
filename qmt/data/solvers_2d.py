...
class SchrodingerPoissonDatas:
    def __init__(
        ...
        :param poisson_obj: A qms.physics.Poisson object containing relevant
            boundary conditions, etc.
        :param densities: list of numpy arrays, corresponding to the density
            in [conduction band, light holes, heavy holes]
    ...
    def _serialize(self):
        ...
        self.content['fixed_charge_site_perimeters'] = \
            self.fixed_charge_site_perimeters
